    ...
    <div className="bg-gray-950 text-white min-h-screen p-6">
      <div className="bg-gray-900 text-white py-12 px-6 rounded-xl shadow-lg max-w-6xl mx-auto mb-12">
        ...
        <p className="text-gray-300 text-base sm:text-lg text-center max-w-4xl mx-auto mb-8">
          Bansal Consultancy is a trusted hiring partner for businesses across
          India, offering complete talent acquisition solutions. Whether you’re
          a startup or a large enterprise, we help you find the right
          professionals quickly and efficiently, tailored exactly to your
      ...
      <section className="bg-gray-900 p-6 rounded-xl mb-12 max-w-5xl mx-auto shadow-md">
        ...
        <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-gray-300 text-sm sm:text-base">
          <li className="flex items-start gap-2">
            <span className="text-yellow-300">✔</span> Industry-specific hiring
            expertise
          </li>
          <li className="flex items-start gap-2">
            <span className="text-yellow-300">✔</span> Quick turnaround for
            urgent hiring
          </li>
          <li className="flex items-start gap-2">
            <span className="text-yellow-300">✔</span> Pre-screened & verified
            candidates
          </li>
          <li className="flex items-start gap-2">
            <span className="text-yellow-300">✔</span> Contract & permanent
            placements
          </li>
          <li className="flex items-start gap-2">
            <span className="text-yellow-300">✔</span> PAN India hiring
            capability
          </li>
          <li className="flex items-start gap-2">
            <span className="text-yellow-300">✔</span> Personalized support for
            every client
          </li>
        </ul>
      </section>
